/* Hidden Harbours — parametric ISO Lobster Boat VARIANTS (M2 bake recipe, ADR-0006 — same pipeline as
   ...
   Exposes globalThis.LobsterBoatVariantsIso = { W,H,PX,DIRS,pivot,order,ROCK,rock(i),
     ...
     helmSeat,haulerMount,tubMounts,navMounts, DECKF,GRIP,GLAS,STEEL,IRON,KEY }.
   opts = { size, style, region, paint, elev, roll, pitch, heave }. */
(function (root) {
  const PX = 32, S = 32;
  ...
  function render(dir, opts){
    ...
    return _toRGBA(_paint(built.F, Object.assign({}, opts, {dir}), matsFor(V.paint)));
  }
