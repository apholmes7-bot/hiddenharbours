...
### 5.3 Regions (LOCKED names — 7 core + commerce layer). Detail in `design/world-and-regions.md`.
| Order | Region | Identity | Gate / why locked |
|-------|--------|----------|-------------------|
| 1 | **Coddle Cove** | Home harbour: uncle's cottage + wharf. Sheltered tutorial waters, inshore beginner fish. | Start zone |
