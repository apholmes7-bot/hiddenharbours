...
(function (root) {
  ...
  function paint(ctx, o){
    ...
    for (let i=0;i<3;i++){ if (compass==='dome' && i===1) continue; const id=layout[i];
      ...
      else if (id==='radar'){ const rp=(root.CapeRig && root.CapeRig.paintRadar) || (window.RadarRig && window.RadarRig.paintInto) || null; screenMount(ctx, slotBox(i,true), 'RADAR', radar, night, o.phase||0, rp); }
