/* Hidden Harbours — parametric ISO OUTSIDE-UTILITY rig (ADR-0006 bake pipeline, SAME turntable +
   ...
   fixed upper-LEFT key, z-buffered, ordered dither, per-face uv texture, depth-edge darkening, 1px
   keyline, NO AA. 32 px = 1 m. All 8 facings fall out of one model, so a pole line rotates in lockstep
