...
namespace HiddenHarbours.Tests.EditMode
{
    ...
    public class FreshnessTests
    {
        ...
        [Test]
        public void SpoiledStillSellsForSomething()
        {
            float gone = Freshness.ValueMultiplier(1f, Policy);
            Assert.AreEqual(Policy.SpoiledValueFloor, gone, 1e-6f);
            Assert.Greater(gone, 0f, "rot costs coin; it never destroys the catch (P5)");
        }
