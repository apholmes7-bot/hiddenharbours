...
const sources=['../rigs/characterIsoRig7.js','../rigs/character/options.json','sources/eyeIsoRig.js','sources/headIsoRig3.js','sources/characterIsoRig6.js',
  'sources/characterIsoRig7.js','boot-segment-fix.cjs','sources/characterIsoRig6.hands.js','sources/proposal.js','sources/face-rig-pass04.js','sources/face-rig-pass05.js','sources/face-rig.js','sources/face-render.cjs','character-finish.js','character-finish.json','cast-engine.js','load-study.cjs','wardrobe-assembly.js','wardrobe-validate.cjs','wardrobe-recipes.json',
