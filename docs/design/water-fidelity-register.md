...
5. **Row 12**: the night level and the shipped searchlight against #691's plates.
6. The check-ins PR 2 will bring: (a) the spilling beach in beats, (b) the plunging ledge as an event.
