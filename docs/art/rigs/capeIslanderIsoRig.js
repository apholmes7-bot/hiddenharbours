...
(function (root) {
  ...
  function render(dir, opts){
    ...
    if(opts.cutaway && root.BoatCutaway) fl=root.BoatCutaway.filter(fl, root.CapeIslanderIso, Object.assign({}, opts, {dir}));   // the depth-correct section — boatCutawayRig.js owns the rule set; absent → byte-identical
