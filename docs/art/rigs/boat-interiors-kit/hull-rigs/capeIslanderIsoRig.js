...
(function (root) {
  ...
  const ROOFZ = 3.02;
  const FYb = 2.54, FYt = 3.10;   // raked front wall bottom/top y — module scope since pass 2 (HOUSE reads them)
  const AY = HY0-0.03;
  ...
  (function build(){
    ...
    // aft wall (-y, into cockpit) — bands around a REAL door opening since pass 2
