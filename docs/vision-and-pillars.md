...
> damaged at the **Nine Mile Creek wharf** (Port Greywick's working waterfront — owner ruling
...
|-------|--------|----------|-------------------|
| 0 | **St Peters Island** *(prologue; owner-ratified, phased **M2**)* | Your **home island**, cut off from the mainland **except at low tide** (a pure P1 tide-gate). A village of 3 houses + a school + a general store. Dig clams at low water on the island flats; at low water a **tide-gated sandbar** to **Greywick** bares as a walking path; there you buy a **cod licence** + a **rod**, sell clams, and **save to buy the damaged dory lying at the Nine Mile Creek wharf — then have her put right** (owner ruling 2026-07-25: that wharf *is* Greywick's, and **no shipwright stands in the region** — seller and repairer are open). **Prepends** Coddle Cove; does not replace it. | The new opening (built **M2**); see §5.8 |
