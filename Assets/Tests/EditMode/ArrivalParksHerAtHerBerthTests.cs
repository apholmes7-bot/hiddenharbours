...
namespace HiddenHarbours.Tests.EditMode
{
    ...
    public class ArrivalParksHerAtHerBerthTests
    {
        ...
        {
            var rig = Build();
            rig.Boat.SetPositionAndRotation(new Vector3(213.50f, 4.25f, 0f), Quaternion.Euler(0f, 0f, 90f));
            rig.Anchor.RememberBoatBerth(rig.Boat);
        ...
        public void ASecondRemembering_CannotOverwriteTheBerthWithTheStandoff()
        {
            ...
            rig.Boat.SetPositionAndRotation(ArrivalSpot, Quaternion.identity);   // where an arrival puts her
            rig.Anchor.RememberBoatBerth(rig.Boat);
